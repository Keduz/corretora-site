...
const navLinks: { href: string; key: TranslationKey }[] = [
  { href: '/', key: 'nav.inicio' },
  { href: '/imoveis', key: 'nav.imoveis' },
  { href: '/servicos', key: 'nav.servicos' },
  { href: '/simulador', key: 'nav.financiamento' },
  { href: '/portais', key: 'nav.portais' },
        ...
        <div className="flex items-center justify-between h-20">
          ...
          <Link href="/" className="flex items-center gap-3 group">
            ...
            <div>
              ...
              <span className="inline-flex items-center gap-1 mt-0.5 px-1.5 py-[1px] rounded bg-olive-500/10 border border-olive-500/25">
                ...
                <span className="text-[8px] uppercase tracking-[0.08em] text-olive-600 font-bold">CRECI-BA 022-670</span>
              </span>
            </div>
          </Link>
          ...
          >
            <div className="px-5 py-6 space-y-4">
              ...
              <Link
                ...
                className="block text-base font-medium text-charcoal-700 hover:text-gold-500 transition-colors"
              >
                {t('nav.favoritos')} {favCount > 0 && `(${favCount})`}
              </Link>
              <button
                type="button"
                onClick={handleWhatsApp}
