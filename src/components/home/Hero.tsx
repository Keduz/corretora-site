    ...
    >
      ...
      <div className="relative z-10 h-full flex items-center justify-center px-5 md:px-10 pointer-events-none">
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            <span
              className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-sm font-semibold tracking-wider border"
              style={{
                borderColor: 'rgba(46, 158, 166, 0.4)',
                background: 'rgba(46, 158, 166, 0.1)',
                color: '#4CB8BF',
              }}
            >
